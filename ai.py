...
ACTION_VELCOCITY = 0.0000002

ACTION_CHANCE = 9
FALLING_STRAIGHT = 100000
...
if __name__ == "__main__":
    ...
    for epi in range(EPISODE):
        step = 0
        action_change_chance = ACTION_CHANCE       # 한 테트로미노의 action 결정권
        while True:
            end_time = time.time()
            ...
            if end_time - action_time >= ACTION_VELCOCITY:
                ...
                if action_change_chance > 0:
                    ...
                    reward, is_new_block = tetris.step(FALLING_STRAIGHT)
